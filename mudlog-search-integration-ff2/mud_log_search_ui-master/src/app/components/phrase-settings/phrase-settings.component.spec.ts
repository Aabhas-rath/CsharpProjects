...
import { PhraseSettingsComponent } from './phrase-settings.component';
...
describe('PhraseSettingsComponent', () => {
  let component: PhraseSettingsComponent;
  let fixture: ComponentFixture<PhraseSettingsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PhraseSettingsComponent);
