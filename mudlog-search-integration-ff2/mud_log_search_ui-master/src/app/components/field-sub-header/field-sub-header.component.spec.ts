...
import { FieldSubHeaderComponent } from './field-sub-header.component';
...
describe('FieldSubHeaderComponent', () => {
  let component: FieldSubHeaderComponent;
  let fixture: ComponentFixture<FieldSubHeaderComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FieldSubHeaderComponent);
